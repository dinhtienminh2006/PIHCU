...
# Creating a function to draw a rectangle on top of stick
...
def write_congraluation_inside_circle(text_color, x, y):
    my_turtle_cursor.penup()
    # Changing color of our cursor
    ...
    my_turtle_cursor.write("Congraluation", font=("sans-serif", 26, "bold"))

    my_turtle_cursor.getscreen().update()

def write_Minh_inside_circle(text_color, x, y):
    my_turtle_cursor.penup()
    # Changing color of our cursor
    my_turtle_cursor.color(text_color)
    ...
    my_turtle_cursor.write("Minh", font=("sans-serif", 26, "bold"))

    my_turtle_cursor.getscreen().update()

def write_ForVisa_inside_circle(text_color, x, y):
    my_turtle_cursor.penup()
    # Changing color of our cursor
    my_turtle_cursor.color(text_color)
    ...
    my_turtle_cursor.write("ForVisa", font=("sans-serif", 26, "bold"))
...
# Drawing a rectangle on top of stick
draw_circle_on_top_of_stick("#181A18", "#FFFDD0", 100, y_coordinate + 235, 100)

# Writing "Congraluation" inside of our circle
write_congraluation_inside_circle("#000000", -70, y_coordinate + 240)

# Writing "Minh" inside of our circle
write_Minh_inside_circle("#000000", -80, y_coordinate + 190)

write_ForVisa_inside_circle("#000000", -50, y_coordinate + 150)
